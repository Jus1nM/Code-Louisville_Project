...
For this project, I decided to use a sample size of 50 people, and what better sample to use than Fortune 50 CEOs, from the top 50 companies within the United States?
